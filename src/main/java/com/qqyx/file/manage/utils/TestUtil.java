    ...
    public static void main(String[] args) {  
        try {  
           // String xml = IOUtils.toString(new FileInputStream(new File(  
                 //  "D:\\hongkangtest.txt")));  
        	   String url = "https://139.219.3.19/apiserviceapp/system/tradeid?from_account=test1&secret=3992488e1b7043708c44238ae20d0dc1";
        	   String resultStr = TestUtil.get(url, "utf-8");
        	   	System.out.println(resultStr);
        	   JSONObject tradeJson = JSONTools.parseToJSONObject(resultStr); 
 			String tradeid =JSONTools.getJSONObject(tradeJson, "trade").getString("id");
        String json = "{\"abstract\":\"研发部 交通报销单 xx项目.\",\"debit_code\":\"103\",\"credit_code\":\"201\",\"money\":\"300\",\"maker\":\"hongye\"}";
            System.out  
                    .println(post(  
                           "https://139.219.3.19/apiserviceapp/api/reimbursementvoucher/add?tradeid="+tradeid+"&from_account=test1&secret=3992488e1b7043708c44238ae20d0dc1&to_account=test2",  
                           json, "html/text", "utf-8", 100000, 100000));  

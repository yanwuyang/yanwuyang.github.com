...
import com.qqyx.file.manage.utils.exception.NetServiceException;
...
public class HttpclientUtil {
	...
	public static String post(String url,String params, String charset) {
		...
		try {
			if (charset == null || StringUtils.isEmpty(charset)) {
				formEntity = new StringEntity(params);
			} else {
				formEntity = new StringEntity(params, charset);
			}
		} catch (UnsupportedEncodingException e) {
			throw new NetServiceException("不支持的编码集", e);
		}
	...
	public static void main(String[] args) {
		...
		params.put("echostr","刘金亮");
		
		for(int i=0;i<10000;i++){
			HttpclientUtil.post("http://127.0.0.1:8000/demo/index",params);
		}*/ 
		
		String params = "{'username':'381447823@qq.com','password':'222222'}";
		HttpclientUtil.post("http://127.0.0.1:8000/login/toLogin",params);
